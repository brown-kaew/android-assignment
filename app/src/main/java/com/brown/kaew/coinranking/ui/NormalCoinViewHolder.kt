...
class NormalCoinViewHolder(view: View) : RecyclerView.ViewHolder(view) {
...
//                    .placeholder(R.drawable.image_loading)
    ...
    companion object {
        fun create(parent: ViewGroup, viewType: Int): NormalCoinViewHolder {
            val layout = R.layout.normal_coin_view_item

            val view = LayoutInflater.from(parent.context)
                .inflate(layout, parent, false)

            return NormalCoinViewHolder(view)
        }
    }
}